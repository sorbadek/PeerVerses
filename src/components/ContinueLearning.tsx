...
const ContinueLearning: React.FC<ContinueLearningProps> = ({ username, lastLogin }) => {
  const courses = [
    {
  ...
  return (
    <div className="bg-gradient-to-r from-cyan-400 via-cyan-500 to-blue-500 rounded-2xl p-6">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-2xl font-bold text-white">Things That Might Interest You</h2>
        <div className="text-sm text-white/70">
          Last active: {new Date(lastLogin * 1000).toLocaleDateString()}
        </div>
      </div>
