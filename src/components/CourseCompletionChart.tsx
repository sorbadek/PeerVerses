...
const CourseCompletionChart: React.FC<CourseCompletionChartProps> = ({ reputationScore, isVerified }) => {
  const stats = [
    ...
    <div className="bg-white rounded-2xl p-6">
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex items-center space-x-2">
          <span className="text-sm text-gray-600">Score: {reputationScore}</span>
          {isVerified && (
