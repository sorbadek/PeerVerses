...
import XPPurchaseModal from './XPPurchaseModal';
...
const XPBalanceCard: React.FC<XPBalanceCardProps> = ({ xpBalance, contributions }) => {
      ...
      <div className="bg-gradient-to-r from-cyan-400 via-cyan-500 to-blue-500 rounded-2xl p-6 text-white relative overflow-hidden">
        <div className="relative z-10">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="text-right">
                <div className="text-3xl font-bold">
                  {showBalance ? xpBalance.toLocaleString() : "••••••"}
                </div>
          ...
          <button 
            ...
            className="bg-white/20 hover:bg-white/30 transition-colors rounded-full px-4 py-2 flex items-center space-x-2 mb-6"
          >
            <Plus size={16} />
          ...
          <div>
            <div className="text-lg font-semibold">{contributions} Contributions made</div>
